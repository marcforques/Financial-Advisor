...
def test_impuesto_tramo_superior_es_30_por_ciento():
    """
    El tramo por encima de 300.000€ tributa al 30% (no al 28%).
    """
    diferencia = impuesto_plusvalia(310_000) - impuesto_plusvalia(300_000)
    assert diferencia == pytest.approx(10_000 * 0.30)


def test_impuesto_progresivo_completo_hasta_tramo_superior():
    """
    Una ganancia que cruza todos los tramos, incluido el superior al
    30%, tributa progresivamente en cada uno.
    """
    # 310.000€: 6.000@19% + 44.000@21% + 150.000@23% + 100.000@27% + 10.000@30%
    esperado = (
        6_000 * 0.19
        + 44_000 * 0.21
        + 150_000 * 0.23
    ...
    assert impuesto_plusvalia(310_000) == pytest.approx(esperado)
