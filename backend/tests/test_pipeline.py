...
def test_pipeline_sin_views_usa_equilibrio(datos_cartera):
    ...
    universo = ["SUAG.L", "XMME.DE", "SGLN.L", "VUSA.AS"]
...
def test_pipeline_con_views_las_aplica(datos_cartera):
    ...
    views_falsas = ViewsGeneradas(
        views=[View(activo="VUSA.AS", rentabilidad_esperada=0.11, justificacion="horizonte largo")]
    )
    ...
    assert resultado["views_usadas"][0]["activo"] == "VUSA.AS"
